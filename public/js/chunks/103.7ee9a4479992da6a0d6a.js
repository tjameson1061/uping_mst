...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var _useEcommerceUi = Object(_useEcommerce__WEBPACK_IMPORTED_MODULE_6__["useEcommerceUi"])(),
        handleOfferActionClick = _useEcommerceUi.handleOfferActionClick,
    ...
    var _useShopUi = Object(_useECommerceShop__WEBPACK_IMPORTED_MODULE_5__["useShopUi"])(),
        ...
        itemViewOptions = _useShopUi.itemViewOptions; // const { offers } = useShopRemoteData()
    ...
    var _useResponsiveAppLeft = Object(_core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_3__["useResponsiveAppLeftSidebarVisibility"])(),
        mqShallShowLeftSidebar = _useResponsiveAppLeft.mqShallShowLeftSidebar; // Wrapper Function for `fetchOffers` which can be triggered initially and upon changes of filters


    var fetchOffers = function fetchOffers(ctx, callback) {
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('http://127.0.0.1:8000/api/admin/offers', {
        q: filters.value.q,
                        ...
                        _vm._l(5, function (star) {
                          return _c(
                            ...
                            [
                              _c("feather-icon", {
                                class: [
                                  { "fill-current": star <= offer.rating },
                                  star <= offer.rating
                                    ? "text-warning"
                                    : "text-muted",
                                ],
                    ...
                    [
                      _c(
                        "b-link",
                        {
                          ...
                          attrs: {
                            to: {
                              name: "apps-e-commerce-offer-details",
...
var useShopFiltersSortingAndPagination = function useShopFiltersSortingAndPagination() {
  ...
  var filterOptions = {
    ...
    categories: ['Internal', 'Adult', 'Gambling', 'Finance', 'Survey', 'Sweepstake', 'Gaming'],
    ratings: [{
      rating: 4,
      count: 160
    }, {
