    ...
    fetchDashboardData: function fetchDashboardData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_19___default.a.get("/api/partner/getDashboardLeadDataPartner/uk/".concat(userData.id)).then(function (response) {
        ...
        _this.$swal({
          ...
          text: 'Contact account manager for approval! Account Manager: Tom Jameson Skype: 12345 Email: tom@uping.co.uk',
          icon: 'info',
...
module.exports = "/images/_/_/_/_/uping-main/resources/js/src/assets/images/slider/04.jpg";
