...
module.exports = "/images/_/_/_/_/uping-main/resources/js/src/assets/images/avatars/flag-uk-icon.png";
...
module.exports = "/images/_/_/_/_/uping-main/resources/js/src/assets/images/avatars/flag-us-icon.png";
...
function useInvoicesList() {
  ...
  var fetchInvoices = function fetchInvoices(ctx, callback, id) {
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch("app-invoice/fetchBuyerInvoices/".concat(id), {
      ...
      // console.log(response.data.invoices[0].invoices)
      // debugger
      var invoices = response.data.invoices[0].invoices.invoices;
