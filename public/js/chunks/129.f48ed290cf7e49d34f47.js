  ...
  methods: {
    approvalModal: function approvalModal() {
      this.$swal({
        ...
        icon: 'info',
        html: '<p>Contact your account manager: </p>' + '<span class="font-weight-bolder">Name: </span> Tom Jameson ' + ' <span class="font-weight-bolder">Email: </span> tom@uping.co.uk ' + ' <span class="font-weight-bolder">Skype: </span> live:.cid.aea911675f20a46c ',
