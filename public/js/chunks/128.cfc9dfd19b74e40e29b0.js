...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var status = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])();
    var password = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])();
    var userEmail = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])();
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            _this.$router.push(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_7__["getHomeRouteForLoggedInUser"])(userData.is_admin ? userData.is_admin : null)).then(function () {
              _this.$toast({
