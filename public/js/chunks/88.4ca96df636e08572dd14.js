...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var userData = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_6__["getUserData"])();
    var userAccountData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])({});
    axios__WEBPACK_IMPORTED_MODULE_7___default.a.get("http://127.0.0.1:8000/api/partner/getUserData/".concat(userData.id)).then(function (res) {
      userAccountData.value = res.data;
    });
    return {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    ...
    var _useInputImageRendere = Object(_core_comp_functions_forms_form_utils__WEBPACK_IMPORTED_MODULE_3__["useInputImageRenderer"])(refInputEl, function (base64) {
      ...
      props.userAccountData.user.avatar = base64;
    }),
        inputImageRenderer = _useInputImageRendere.inputImageRenderer;

    function resetForm() {
      this.optionsLocal = JSON.parse(JSON.stringify(this.userAccountData));
    }
    ...
    function updateAccountSettingsForm(ev) {
      ...
      // loading.value = true;
      // console.log(props.userAccountData.user)
      // debugger

      this.$http.patch('/partner/updateAccountInfo/1', this.userAccountData).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    var userData = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_7__["getUserData"])();
    ...
    function updateCompanyInfo(ev) {
      ...
      // console.log(this.userAccountData.user.company)
      // debugger

      this.$http.patch("/partner/updateCompany/".concat(userData.id), props.userAccountData.user.company).then(function (res) {
        // console.log(res)
        // debugger
        _this.$toast({
    ...
    var countryOption = ['UK', 'USA', 'India', 'Canada'];
    return {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    var passwordValueOld = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])();
    var newPasswordValue = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])();
    var RetypePassword = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])();
    var passwordFieldTypeOld = 'password';
    var passwordFieldTypeNew = 'password';
    var passwordFieldTypeRetype = 'password';
    ...
    function UpdateAccountPassword(ev) {
      ev.preventDefault();
      console.log(ev); // loading.value = true;
      // console.log(props.userAccountData.user)
      // debugger

      this.$http.patch("/partner/updateAccountPassword/".concat(userData.id), newPasswordValue).then(function (res) {
        console.log(res); // debugger
    ...
    return {
      ...
      goBack: goBack,
      togglePasswordRetype: togglePasswordRetype,
      togglePasswordNew: togglePasswordNew,
      togglePasswordOld: togglePasswordOld,
      userData: userData,
      passwordValueOld: passwordValueOld,
      newPasswordValue: newPasswordValue,
      RetypePassword: RetypePassword,
      passwordFieldTypeOld: passwordFieldTypeOld,
      passwordFieldTypeNew: passwordFieldTypeNew,
      passwordFieldTypeRetype: passwordFieldTypeRetype,
      toast: toast
    };
  }
});
      ...
      _c(
        ...
        [
          ...
          _c("account-setting-general", {
            attrs: { "user-account-data": _vm.userAccountData },
          }),
        ],
        1
      ),
          ...
          _c(
            ...
            [
              _c(
                "b-media-aside",
                [
                  _vm.userAccountData.user.avatar !== "default.jpg"
                    ? _c("b-avatar", {
                        ref: "previewEl",
                        attrs: {
                          src: _vm.userAccountData.user.avatar,
                          size: "90px",
                          rounded: "",
                        },
                      })
          ...
          _c(
            ...
            [
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.username,
                          callback: function ($$v) {
                            _vm.$set(_vm.userAccountData.user, "username", $$v)
                          },
                          expression: "userAccountData.user.username",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.name,
                          callback: function ($$v) {
                            _vm.$set(_vm.userAccountData.user, "name", $$v)
                          },
                          expression: "userAccountData.user.name",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.email,
                          callback: function ($$v) {
                            _vm.$set(_vm.userAccountData.user, "email", $$v)
                          },
                          expression: "userAccountData.user.email",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.name,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "name",
                              $$v
                            )
                          },
                          expression: "userAccountData.user.company.name",
                        },
                      }),
                    ],
                    1
              ...
              _c(
                ...
                [
                  _vm.userAccountData.user.email_verified_at == null
                    ? _c(
                        "b-alert",
                        {
                          staticClass: "mb-50",
                  ...
                  _c(
                    ...
                    [
                      _c("flat-pickr", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.created_at,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "created_at",
                          ...
                          expression: "userAccountData.user.company.created_at",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        attrs: { id: "phone" },
                        model: {
                          value: _vm.userAccountData.user.company.phone,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "phone",
                          ...
                          expression: "userAccountData.user.company.phone",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        attrs: { id: "website" },
                        model: {
                          value: _vm.userAccountData.user.company.website,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "website",
                          ...
                          expression: "userAccountData.user.company.website",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        attrs: { id: "skype" },
                        model: {
                          value: _vm.userAccountData.user.company.skype,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "skype",
                          ...
                          expression: "userAccountData.user.company.skype",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        attrs: { id: "address1" },
                        model: {
                          value: _vm.userAccountData.user.company.address1,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "address1",
                          ...
                          expression: "userAccountData.user.company.address1",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.address2,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "address2",
                          ...
                          expression: "userAccountData.user.company.address2",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.postcode,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "postcode",
                          ...
                          expression: "userAccountData.user.company.postcode",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        attrs: { id: "city" },
                        model: {
                          value: _vm.userAccountData.user.company.city,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "city",
                          ...
                          expression: "userAccountData.user.company.city",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.state,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "state",
                          ...
                          expression: "userAccountData.user.company.state",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.userAccountData.user.company.country,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.userAccountData.user.company,
                              "country",
                          ...
                          expression: "userAccountData.user.company.country",
                        },
                      }),
                    ],
                    1
