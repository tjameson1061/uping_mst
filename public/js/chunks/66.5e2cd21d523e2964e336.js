...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var success = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(); // const userData = getUserData()
    ...
    function updateAccountSettingsForm(ev) {
      ...
      debugger;
      this.$http.patch("/partner/updateAccountInfo/".concat(this.userData.user.id), this.userData).then(function (res) {
