...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var status = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_12__["ref"])();
    var password = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_12__["ref"])();
    var email = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_12__["ref"])();
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].setRefreshToken(response.data.refresh_token);
            localStorage.setItem('userData', JSON.stringify(userData));

            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_10__["getHomeRouteForLoggedInUser"])(userData.is_admin ? userData.is_admin : null)).then(function () {
              _this.$toast({
    ...
    }, Object(_Users_tomjameson_PhpstormProjects_uping_new_full_version_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "email", email), Object(_Users_tomjameson_PhpstormProjects_uping_new_full_version_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "login", login), _ref;
  }
});
