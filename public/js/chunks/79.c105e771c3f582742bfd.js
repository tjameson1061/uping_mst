...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var ACCOUNT_SETTINGS = "admin-account-setting";
    var userData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])({}); // Register module

    if (!store.hasModule(ACCOUNT_SETTINGS)) store.registerModule(ACCOUNT_SETTINGS, AccountSettingsStoreModule); // UnRegister on leave
    ...
    store.dispatch("admin-account-setting/getUserData/".concat(userData.id)).then(function (response) {
