    ...
    fetchDashboardData: function fetchDashboardData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_19___default.a.get("/api/partner/getDashboardLeadDataPartner/uk/".concat(userData.id)).then(function (response) {
        ...
        _this.$swal({
          ...
          icon: 'info',
          html: '<p>Compliance required.</p>' + '<p><span class="font-weight-bolder">Name: </span> Tom Jameson, ' + '<span class="font-weight-bolder">Email: </span>tom@uping.co.uk, ' + '<span class="font-weight-bolder">Skype: </span>live:.cid.aea911675f20a46c, ' + '<a href="https://pixinvent.com/" target="_blank">links</a> ',
