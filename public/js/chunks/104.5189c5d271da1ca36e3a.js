                  ...
                  _c(
                    ...
                    [
                      offer.id == 1 || offer.id == 2 || offer.id == 3
                        ...
                        : offer.id == 4 || offer.id == 5 || offer.id == 6
                        ? _c("b-img", {
                            staticClass: "card-img-top",
                            attrs: {
                              alt: offer.name + "-" + offer.id,
...
module.exports = "/images/_/_/_/_/full-version/resources/js/src/assets/images/offer_logo/magic-lend.png";
...
var useShopFiltersSortingAndPagination = function useShopFiltersSortingAndPagination() {
  ...
  var filterOptions = {
    ...
    brands: ['loanie™', 'magiclend', 'Metra', 'HP', 'Apple', 'GE', 'Sony', 'Incipio', 'KitchenAid', 'Whirlpool'],
    ratings: [{
      rating: 4,
      count: 160
    }, {
