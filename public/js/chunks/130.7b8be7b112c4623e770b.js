      ...
      this.$refs.simpleRules.validate().then(function (success) {
        if (success) {
          _this.$http.post("/forgot-password", {
            ...
            if (result.data.email) _this.$toast({
