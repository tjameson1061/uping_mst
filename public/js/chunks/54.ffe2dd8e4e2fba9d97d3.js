...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var userData = ref({});
    axios__WEBPACK_IMPORTED_MODULE_9___default.a.get("/partner/getUserData/".concat(user.id)).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    ...
    function updateAccountSettingsForm(ev) {
      ...
      this.$http.patch("/partner/updateAccountInfo/".concat(props.userData.user.id), this.userData).then(function (res) {
