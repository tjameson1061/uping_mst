...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      // validation rules
      required: _validations__WEBPACK_IMPORTED_MODULE_5__["required"] // email,
      //   errors,
  ...
  methods: {
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].login({
            email: _this.email,
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].setToken(response.data.access_token);
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].setRefreshToken(response.data.refresh_token);
            localStorage.setItem('userData', JSON.stringify(userData));

            if (userData.is_admin == 1) {
              _this.$router.go('/dashboard/admin/uk').then(function () {
                debugger;
                ...
                _this.$toast({
                  ...
                  props: {
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: "You have successfully logged in as ".concat(userData.is_admin, ". Now you can start to explore!")
                  }
                });
                ...
                _this.$refs.loginForm.setErrors(error.response.error);
              });
            } else if (userData.is_admin == 0) {
              console.log(userData.is_admin);
              debugger;

              _this.$router.go('/dashboard/partner/uk').then(function () {
                _this.$toast({
                  component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
                  position: 'top-right',
                  props: {
              ...
              _this.$router.go('/dashboard/offer').then(function () {
                debugger;
