...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate: function beforeCreate() {
    ...
    this.$http.get('/partner/getUserData/1').then(function (res) {
