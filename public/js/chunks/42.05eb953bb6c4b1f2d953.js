...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchDashboardData: function fetchDashboardData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_18___default.a.get("/api/partner/getDashboardLeadDataPartner/uk/".concat(userData.id)).then(function (response) {
