...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    }, Object(_Users_tomjameson_PhpstormProjects_uping_new_full_version_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "email", _validations__WEBPACK_IMPORTED_MODULE_7__["email"]), Object(_Users_tomjameson_PhpstormProjects_uping_new_full_version_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "errors", errors), _ref;
  },
  computed: {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_6__["default"].login({
            ...
            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_10__["getHomeRouteForLoggedInUser"])(userData.is_admin)).then(function () {
              _this.$toast({
