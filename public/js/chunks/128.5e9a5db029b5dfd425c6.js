      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            _this.$router.push(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_7__["getHomeRouteForLoggedInUser"])(userData.is_admin ? userData.is_admin : null)).then(function (resp) {
              console.log(resp);
              debugger;
