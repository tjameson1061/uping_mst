...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var url = ref(window.location.href); // const userEmail = ref()
    // const cPassword = ref()
    // const password = ref()
    ...
    function validationForm() {
      ...
      this.$refs.simpleRules.validate().then(function (success) {
        if (success) {
          axios__WEBPACK_IMPORTED_MODULE_7___default.a.post('http://127.0.0.1:8000/api/reset-password', resetData.value).then(function (response) {
