    ...
    fetchDashboardData: function fetchDashboardData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_19___default.a.get("/api/partner/getDashboardLeadDataPartner/uk/".concat(userData.id)).then(function (response) {
        ...
        _this.$swal({
          ...
          icon: 'info',
          html: 'Compliance required.' + '<span class="font-weight-bolder">Name: Tom Jameson</span>, ' + '<span class="font-weight-bolder">Email: tom@uping.co.uk</span>, ' + '<span class="font-weight-bolder">Skype: live:.cid.aea911675f20a46c</span>, ' + '<a href="https://pixinvent.com/" target="_blank">links</a> ' + 'and other HTML tags',
