...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var _useShopRemoteData = Object(_useECommerceShop__WEBPACK_IMPORTED_MODULE_5__["useShopRemoteData"])(),
        ...
        fetchOffers = _useShopRemoteData.fetchOffers;
    ...
    var fetchShopProducts = function fetchShopProducts(callback) {
      fetchOffers({
        q: filters.value.q,
        ...
        totalPostbacks.value = offers.total;
      });
    };
                ...
                [
                  _c("b-img", {
                    ...
                    attrs: {
                      ...
                      src: offer.logo,
                      to: {
                        name: "apps-partner-offers-details",
                        params: { id: offer.id },
                      },
                    },
                  }),
