...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Your account password has been reset.</div>
  <div role="article" aria-roledescription="email" aria-label="Account password has been reset" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                        ...
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">This is a confirmation of following::</p>
                        <ul style="margin-bottom: 24px;">
                          <li>You have successfully changed your password.</li>
                          <li>Login to UPING with your new credentials.</li>
                        </ul>
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                          If you did not change your password or need our help keeping the account, please
                          contact us at
