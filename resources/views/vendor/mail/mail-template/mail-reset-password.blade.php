...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  ...
  <td class="sm-py-32 sm-px-24" style="mso-line-height-rule: exactly; padding: 48px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
    <a href="https://portal.uping.co.uk/login" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
...
<!--                          <a href="mailto:john@uping.co.uk" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">john@uping.co.uk</a>-->
...
<!--                        </p>-->
                        ...
                        <a href="https://portal.uping.co.uk?reset_password_url" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 24px; display: block; font-size: 16px; line-height: 100%; color: #7367f0; text-decoration: none;">https://portal.uping.co.uk?reset-password/{{ $token }}</a>
