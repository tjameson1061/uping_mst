...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'UK Leads', route: { name: 'apps-uk-lead-list' }, icon: 'FilterIcon', isBookmarked: true },
      { title: 'US Leads', route: { name: 'apps-us-lead-list' }, icon: 'FilterIcon', isBookmarked: true },
      { title: 'Mappings', route: { name: 'apps-mapping-list' }, icon: 'UserIcon', isBookmarked: true },
      { title: 'Buyer', route: { name: 'apps-buyer-list' }, icon: 'UserIcon', isBookmarked: false },
