    ...
    >
      ...
      >
        ...
        >
              ...
              <!-- Header: Left Content -->
                <div>
                    <div class="logo-wrapper">
                            <img src="@/assets/images/logo/logo.png" alt="Logo" width="150" height="45">
                    </div>
            ...
            <b-row class="invoice-spacing">
              ...
              >
                ...
                <p class="card-text mb-25">
                  {{ invoiceData.company.webiste }}
                </p>
                <p class="card-text mb-25">
                  {{ invoiceData.company.address1 }}, {{ invoiceData.company.city }}
                </p>
                  <p class="card-text mb-25">
                  {{ invoiceData.company.state }}, {{ invoiceData.company.country }}
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ invoiceData.payment.bank_name }}</td>
                      </tr>
                      <tr>
                        <td class="pr-1">
                          Country:
                        </td>
                        <td>{{ invoiceData.payment.bank_country }}</td>
                      </tr>
                      <tr>
                        <td class="pr-1">
                          IBAN:
                        </td>
                        <td>{{ invoiceData.payment.bank_iban }}</td>
                      </tr>
                      <tr>
                        <td class="pr-1">
                          SWIFT code:
                        </td>
                        <td>{{ invoiceData.payment.bank_swift }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          >
            <template #cell(descriptiom)="data">
...
<!--                </b-card-text>-->
                ...
                <div class="invoice-total-wrapper">
                  <div class="invoice-total-item">
                    ...
                    <p class="invoice-total-amount">
                        <span v-if="invoiceData.currency == 1" >
          ...
          <b-card-body class="invoice-padding pt-0">
            ...
            <span>It was a pleasure working with you and your team. All the best!!</span>
          </b-card-body>
        </b-card>
      </b-col>
...
export default {
  ...
  setup() {
    ...
    // Register module
    if (!store.hasModule(INVOICE)) store.registerModule(INVOICE, invoiceStoreModule)
