                ...
                >
                  ...
                  >
                    ...
                    <b-card-text class="mb-25">
                      ...
                      <b-card-text class="mb-25">
                          {{ invoiceData.company.state }},  {{ invoiceData.company.postcode }}, {{ invoiceData.company.country }},
                      </b-card-text>
                    <b-card-text class="mb-0">
  ...
  setup() {
    ...
    store
      ...
      .then(response => {
        ...
        paymentDetails.value = response.data.invoice.payment
        // productItems.value = response.data.invoice.products
    ...
    const updateItemForm = (index, val) => {
      const { price, qty, description } = val
