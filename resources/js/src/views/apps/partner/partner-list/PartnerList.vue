      ...
      >
              ...
              <b-media vertical-align="center">
                  ...
                  >
                          <b-badge variant="light-primary">
                              {{ data.item.partner.length  }} AFF ID's
                      </b-badge>
                  </b-link>
              </b-media>
          </template>
        ...
        <template #cell(affiliate)="data">
          <div class="text-nowrap">
            <feather-icon
              :icon="resolvePartnerRoleIcon(data.item.affiliate)"
              size="18"
              class="mr-50"
              :class="`text-${resolvePartnerRoleVariant(data.item.affiliate)}`"
            />
            <span class="align-text-top text-capitalize">{{ data.item.affiliate }}</span>
          </div>
        </template>
...
export default {
  ...
  setup() {
      ...
      store.dispatch('app-partners/fetchFilterData')
          .then(response => {
