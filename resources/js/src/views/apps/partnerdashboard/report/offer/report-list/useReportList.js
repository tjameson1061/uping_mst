...
export default function useReportsList() {
  ...
  const tableColumns = [
    ...
    { key: 'aff_click_id', label: 'AFF Click ID', sortable: true },
    { key: 'aff_sub', label: 'AFF SUB',  sortable: true },
    { key: 'aff_sub2', label: 'AFF SUB2',  sortable: true },
    { key: 'aff_sub3', label: 'AFF SUB3',  sortable: true },
    { key: 'aff_sub4', label: 'AFF SUB4',  sortable: true },
    { key: 'aff_sub5', label: 'AFF SUB5',  sortable: true },
    // { key: 'actions' },
  ]
