<template>
    <div>
        ...
        <b-card>
            ...
            <template #cell(uk_lead)="data">
              <b-badge pill
                       v-ripple.400="'rgba(113, 102, 240, 0.15)'"
                       v-b-modal.modal-post-uk-lead
                       variant="light-primary"
                  @click="modalUkLead(data.item.uk_lead)">
                  View
              </b-badge>
          </template>
...
<!--                @click="modalPostResponse(data.item.post_response)">-->
            ...
            >
                ...
                <ul>
                    <li v-for="(item, index) in modalUkLeadData">
