    ...
    >
        ...
        <b-form @submit.prevent>
          ...
          >
              ...
              <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                ...
                <div class="invoice-number-date mt-md-0 mt-2">
                  ...
                  <div class="d-flex align-items-center mb-1">
                    ...
                    <flat-pickr
                      v-model="leadLogData.issuedDate"
            ...
            >
              <b-row class="invoice-spacing">
                ...
                >
                  ...
                  <!-- Selected Client -->
                  <div
                    v-if="leadLogData.client"
                    class="mt-1"
                  >
                    <h6 class="mb-25">
                      {{ leadLogData.client.name }}
                    </h6>
                    <b-card-text class="mb-25">
                      {{ leadLogData.client.company }}
                    </b-card-text>
                    <b-card-text class="mb-25">
                      {{ leadLogData.client.address }}, {{ leadLogData.client.country }}
                    </b-card-text>
                    <b-card-text class="mb-25">
                      {{ leadLogData.client.contact }}
                    </b-card-text>
                    <b-card-text class="mb-0">
                      {{ leadLogData.client.companyEmail }}
                    </b-card-text>
                  </div>
                </b-col>
            ...
            <b-card-body class="invoice-padding form-item-section">
              ...
              >
                <b-row
                  v-for="(item, index) in leadLogData.items"
                  :key="index"
                  ref="row"
                  class="pb-2"
                >
              ...
              <b-row>
                ...
                >
                  ...
                  <b-form-input
                    ...
                    v-model="leadLogData.salesPerson"
            ...
            <b-card-body class="invoice-padding pt-0">
              ...
              <b-form-textarea v-model="leadLogData.note" />
            </b-card-body>
          </b-card>
        </b-form>
      </b-col>
      ...
      >
        ...
        <div class="mt-2">
          ...
          >
            <v-select
              v-model="leadLogData.paymentMethod"
              :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
          ...
          <!-- ? Below values are not adding leadLogData to keep leadLogData more generic and less confusing  -->
...
import leadLogStoreModule from '../leadLogStoreModule'
import LeadLogSidebarSendInvoice from '../LeadLogSidebarSendInvoice.vue'
import LeadLogSidebarAddPayment from '../LeadLogSidebarAddPayment.vue'
...
export default {
  components: {
    ...
    vSelect,
    Logo,
    LeadLogSidebarSendInvoice,
    LeadLogSidebarAddPayment,
  },
  directives: {
    Ripple,
    'b-toggle': VBToggle,
  ...
  methods: {
    addNewItemInItemForm() {
      ...
      this.leadLogData.items.push(JSON.parse(JSON.stringify(this.itemFormBlankItem)))
    ...
    removeItem(index) {
      this.leadLogData.items.splice(index, 1)
  ...
  setup() {
    const LEADLOG_APP_STORE_MODULE_NAME = 'app-invoice'

    // Register module
    if (!store.hasModule(LEADLOG_APP_STORE_MODULE_NAME))
      store.registerModule(LEADLOG_APP_STORE_MODULE_NAME, leadLogStoreModule)

    // UnRegister on leave
    onUnmounted(() => {
      if (store.hasModule(LEADLOG_APP_STORE_MODULE_NAME)) store.unregisterModule(LEADLOG_APP_STORE_MODULE_NAME)
    })
    ...
    store
      ...
      .then(response => {
        leadLogData.value = response.data.invoice
        ...
        leadLogData.value.note =
          'It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!'
        leadLogData.value.paymentMethod = 'Bank Account'
      })
      .catch(error => {
    ...
    const updateItemForm = (index, val) => {
      ...
      leadLogData.value.items[index].cost = cost
      leadLogData.value.items[index].qty = qty
      leadLogData.value.items[index].description = description
    }
