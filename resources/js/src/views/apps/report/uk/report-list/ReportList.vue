<template>
  ...
  <div>
    ...
    <reports-list-filters
      ...
      :vendor-lead-price-filter.sync="vendorPriceFilter"
      :buyer-lead-price-filter.sync="buyerPriceFilter"
      :status-filter.sync="statusFilter"

      :filter-data="filterData"
      :status-options="statusOptions"
      :sub-id-options="subIdOptions"
          ...
          <template #cell(profit)="data">
              <b-media vertical-align="center">
                  ...
                  <small v-else class="text-success">
                      {{  '£'+ (data.item.buyerLeadPrice - data.item.vidLeadPrice).toFixed(2) }}
                  </small>
              </b-media>
          </template>
...
export default {
  components: {
    ...
    setup() {
        ...
        const buyerLeadPrice_ids = ref()
        const vidLeadPrice_ids = ref()
        const tier_ids = ref()
        // const subIds = ref(null)
        // Register module
