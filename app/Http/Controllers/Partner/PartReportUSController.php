...
class PartReportUSController extends Controller
{
...
//        $report_data['postback_reports'] = $this->getPostbackReports($id);
    ...
    public function getUSReports(Request $request, $id)
    {
        ...
        $reports = USLead::select('vid', 'subid', 'vidLeadPrice', 'buyerTierID', 'isRedirected', 'tier', 'leadStatus', 'created_at')
            ->where('vid', $vendor_id)
            ->where($wherelist)
