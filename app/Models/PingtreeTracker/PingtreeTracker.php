...
namespace App\Models\PingtreeTracker;
...
//        dd($lead_count);
        ...
        $total_sales = USLead::whereDate('created_at', '=', Carbon::today())
            ->where('buyerTierID', '=', $buyer_tier_id)
            ->where('model_type', '=', 5)
...
//        }
    ...
    public static function update_epl($epl, $buyer_tier_id)
    {
        ...
        $buyer = DB::table('pingtree_tracker_u_s')->where('buyersetup_id', '=', $buyer_tier_id)->first();
