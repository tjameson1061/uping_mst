...
class Application
{
    ...
    private $validation_rules = [
        ...
        'instanceOf' => [
            [['Application'], 'LTG\ApplicationDetails'],
            [['SourceDetails'], 'LTG\SourceDetails'],
        ]
    ];
...
//            }
            ...
            curl_setopt($ch, CURLOPT_URL, "https://api.leadtreeglobal.com/4dd3204d-a01d-452d-ae48-8d8c86343000/ ");
            ...
            Log::debug('LTG::', (array) $server_output);
            ...
            Log::debug('LTG, INVALID Application');
