...
//        dd($this->statuscheckurl);
        if (!is_null($this->logger)) {
            $this->logger->info("status request sent: https://portal.uping.co.uk/application/usa/status/" . $this->statuscheckurl);
        }

        curl_setopt($ch, CURLOPT_URL, "https://portal.uping.co.uk/application/usa/status/" . $this->statuscheckurl);
