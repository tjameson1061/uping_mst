<?php
namespace App\Buyerapis\vendor\papersky\bizfellausa\src\BizFellaUSA;
...
class Status
{
    ...
    public function refresh()
    {
        ...
        if (!is_null($this->logger)) {
            $this->logger->info("status request sent: http://localhost/leads" . $this->statuscheckurl);
        }

        curl_setopt($ch, CURLOPT_URL, "http://localhost/leads" . $this->statuscheckurl);
