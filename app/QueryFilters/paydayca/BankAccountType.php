...
class BankAccountType
{
    ...
    public function applyFilters($lead)
    {
        ...
        */
        ...
        $post = (new ShouldContain)->applyFilters($post, $values1, $buyerTierID, 'batsc');

        $post = (new ShouldBe)->applyFilters($post, $values2, $buyerTierID, 'batsb');
